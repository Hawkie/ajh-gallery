...
export class ExhibitsComponent extends Component<{}, IExhibitsState> {
  ...
  public click(radioId: number): void {
    this.setState((prevState: IExhibitsState) => ({
      ...
      assemblages:
        (radioId & categoryEnum.Assemblage) === categoryEnum.Assemblage,
      // tslint:disable-next-line:no-bitwise
  ...
  public async componentDidMount() {
    const data: IExhibitDetail[] = await readAll(
      "/.netlify/functions/galleryData",
    );
    this.setState((prevState: IExhibitsState) => ({ ...prevState, data }));
  }
}
